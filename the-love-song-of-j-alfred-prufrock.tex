...
\fbox{
    \begin{minipage}{6cm}
        ...
        questa fiamma staria senza piu scosse.\\ % there should be a bar over u in piu
...
\begin{minipage}{8cm}
    ...
    \begin{minipage}{8cm}
        ...
        \reflectbox{When the wind blows the water white and black.}
    ...
    \begin{minipage}{8cm}
        ...
        \reflectbox{Till human voices wake us, and we drown.}
...
\begin{minipage}{9cm}
    ...
    \reflectbox{I shall wear the bottoms of my trousers rolled.}
    ...
    \reflectbox{I have heard the mermaids singing, each to each.}
    \begin{center}[16]\end{center}
    \end{minipage}

    \begin{minipage}{9cm}
    \flushright
    \reflectbox{I do not think that they will sing to me.}
